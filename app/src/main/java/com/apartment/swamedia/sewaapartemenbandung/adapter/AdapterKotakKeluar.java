 ...
 */
public class AdapterKotakKeluar extends RecyclerView.Adapter<AdapterKotakKeluar.MyViewHolder> {
    ...
    public AdapterKotakKeluar(Context context, List<InformationMessaging> data) {
    ...
    @Override
    public AdapterKotakKeluar.MyViewHolder onCreateViewHolder(ViewGroup viewGroup, int i) {
    ...
    @Override
    public void onBindViewHolder(AdapterKotakKeluar.MyViewHolder holder, int i) {
