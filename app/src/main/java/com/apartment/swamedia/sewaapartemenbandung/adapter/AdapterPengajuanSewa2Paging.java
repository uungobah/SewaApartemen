 ...
 */
public class AdapterPengajuanSewa2Paging extends RecyclerView.Adapter {
    ...
    public AdapterPengajuanSewa2Paging (Context context, List<InformationPengajuanSewa2> data,RecyclerView recyclerView) {
    ...
    public void onBindViewHolder(RecyclerView.ViewHolder hoder, int i) {
        ...
        if (hoder instanceof MyViewHolder) {
            AdapterPengajuanSewa2Paging.MyViewHolder holder = (AdapterPengajuanSewa2Paging.MyViewHolder) hoder;
