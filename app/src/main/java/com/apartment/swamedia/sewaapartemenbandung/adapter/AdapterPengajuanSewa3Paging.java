 ...
 */
public class AdapterPengajuanSewa3Paging extends RecyclerView.Adapter{
    ...
    public AdapterPengajuanSewa3Paging(Context context, List<InformationPengajuanSewa3> data,RecyclerView recyclerView) {
