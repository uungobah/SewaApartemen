 ...
 */
public class AdapterPermintaanSewa1Paging extends RecyclerView.Adapter {
    ...
    public AdapterPermintaanSewa1Paging(Context context, List<InformationPermintaanSewa1> data,RecyclerView recyclerView) {
    ...
    public void onBindViewHolder(RecyclerView.ViewHolder hoder, int i) {
        ...
        if (hoder instanceof MyViewHolder) {
            AdapterPermintaanSewa1Paging.MyViewHolder holder = (AdapterPermintaanSewa1Paging.MyViewHolder) hoder;
