 ...
 */
public class FragmentTab1PengajuanSewa extends Fragment {
    private RecyclerView recyclerView;
    private AdapterPengajuanSewa1Paging adapter;
    JSONObject jobj;
    ...
    List<InformationPengajuanSewa1> data = new ArrayList<>();
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container, Bundle savedInstanceState) {
        v = inflater.inflate(R.layout.tab1_pengajuan_sewa, container, false);
        ctx = getContext();
        iduser = "";

        sharedPreferences = ctx.getSharedPreferences(ConstantUtil.SHAREDPREFERENCE.LOGIN, Context.MODE_PRIVATE);

        recyclerView = (RecyclerView) v.findViewById(R.id.rv_pengajuan1_sewa);
...
//                                    int[] img_apartment = {R.drawable.photo_apartment, R.drawable.photo_apartment, R.drawable.photo_apartment, R.drawable.photo_apartment, R.drawable.photo_apartment};
                                    if (jarr.length() > 0) {
                                        ...
                                        for (int i = 0; i < jarr.length(); i++) {
                                            ...
                                            InformationPengajuanSewa1 current = new InformationPengajuanSewa1();
                                        ...
                                        if (page < 2) {
                                            ...
                                            adapter = new AdapterPengajuanSewa1Paging(ctx, data, recyclerView);
