 ...
 */
public class FragmentTab1PermintaanSewa extends Fragment {
    private RecyclerView recyclerView;
    private AdapterPermintaanSewa1Paging adapter;
    JSONObject jobj;
    ...
    List<InformationPermintaanSewa1> data = new ArrayList<>();
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container, Bundle savedInstanceState) {
        v = inflater.inflate(R.layout.tab1_permintaan_sewa, container, false);
        ctx = getContext();
        iduser = "";

        sharedPreferences = ctx.getSharedPreferences(ConstantUtil.SHAREDPREFERENCE.LOGIN, Context.MODE_PRIVATE);

        recyclerView = (RecyclerView) v.findViewById(R.id.rv_permintaan_sewa);
...
//                                    int[] img_apartment = {R.drawable.photo_apartment, R.drawable.photo_apartment, R.drawable.photo_apartment, R.drawable.photo_apartment, R.drawable.photo_apartment};
                                    if (jarr.length() > 0) {
                                        ...
                                        if (page < 2) {
                                            ...
                                            adapter = new AdapterPermintaanSewa1Paging(ctx, data, recyclerView);
