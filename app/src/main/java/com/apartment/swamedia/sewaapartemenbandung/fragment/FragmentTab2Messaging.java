...
import com.apartment.swamedia.sewaapartemenbandung.adapter.AdapterKotakKeluar;
...
/**
 * Created by swa on 1/22/2016.
 */
public class FragmentTab2Messaging extends Fragment {
    private RecyclerView recyclerView;
    private AdapterKotakKeluar adapter;
    JSONObject jobj;
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container, Bundle savedInstanceState) {
        v = inflater.inflate(R.layout.tab2_messaging, container, false);
        ctx = getContext();
        iduser="";

        sharedPreferences = ctx.getSharedPreferences(ConstantUtil.SHAREDPREFERENCE.LOGIN, Context.MODE_PRIVATE);

        recyclerView = (RecyclerView) v.findViewById(R.id.rv_kotak_keluar);
    ...
    public void getKotakKeluar() {
        ...
        String url = ConstantUtil.WEB_SERVICE.URL_KOTAK_KELUAR;
...
//                                    int[] img_apartment = {R.drawable.photo_apartment, R.drawable.photo_apartment, R.drawable.photo_apartment, R.drawable.photo_apartment, R.drawable.photo_apartment};
                                    ...
                                    adapter = new AdapterKotakKeluar(ctx, data);
