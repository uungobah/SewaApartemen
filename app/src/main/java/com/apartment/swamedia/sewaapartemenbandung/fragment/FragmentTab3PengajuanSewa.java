...
import com.apartment.swamedia.sewaapartemenbandung.adapter.AdapterPengajuanSewa3;
import com.apartment.swamedia.sewaapartemenbandung.adapter.AdapterPengajuanSewa3Paging;
...
import com.apartment.swamedia.sewaapartemenbandung.adapter.InformationPengajuanSewa3;
 ...
 */
public class FragmentTab3PengajuanSewa extends Fragment {
    private RecyclerView recyclerView;
    private AdapterPengajuanSewa3Paging adapter;
    JSONObject jobj;
    ...
    int page = 1;
    List<InformationPengajuanSewa3> data = new ArrayList<>();
    protected Handler handler;

    @Nullable
    @Override
    public View onCreateView(LayoutInflater inflater, ViewGroup container, Bundle savedInstanceState) {
        v = inflater.inflate(R.layout.tab3_pengajuan_sewa, container, false);
        ctx = getContext();
        iduser = "";

        sharedPreferences = ctx.getSharedPreferences(ConstantUtil.SHAREDPREFERENCE.LOGIN, Context.MODE_PRIVATE);

        recyclerView = (RecyclerView) v.findViewById(R.id.rv_pengajuan3_sewa);
...
//                                    int[] img_apartment = {R.drawable.photo_apartment, R.drawable.photo_apartment, R.drawable.photo_apartment, R.drawable.photo_apartment, R.drawable.photo_apartment};
                                    if (jarr.length() > 0) {
                                        ...
                                        for (int i = 0; i < jarr.length(); i++) {
                                            ...
                                            InformationPengajuanSewa3 current = new InformationPengajuanSewa3();
                                            ...
                                            current.reject = c.getString("rejectReason");
                                            data.add(current);
                                        ...
                                        if (page < 2) {
                                            ...
                                            adapter = new AdapterPengajuanSewa3Paging(ctx, data, recyclerView);
