...
import com.apartment.swamedia.sewaapartemenbandung.adapter.AdapterPermintaanSewa3;
import com.apartment.swamedia.sewaapartemenbandung.adapter.AdapterPermintaanSewa3Paging;
 ...
 */
public class FragmentTab3PermintaanSewa extends Fragment {
    private RecyclerView recyclerView;
    private AdapterPermintaanSewa3Paging adapter;
    JSONObject jobj;
    ...
    List<InformationPermintaanSewa3> data = new ArrayList<>();
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container, Bundle savedInstanceState) {
        v = inflater.inflate(R.layout.tab3_permintaan_sewa, container, false);
        ctx = getContext();
        iduser = "";

        sharedPreferences = ctx.getSharedPreferences(ConstantUtil.SHAREDPREFERENCE.LOGIN, Context.MODE_PRIVATE);

        recyclerView = (RecyclerView) v.findViewById(R.id.rv_permintaan3_sewa);
...
//                                    int[] img_apartment = {R.drawable.photo_apartment, R.drawable.photo_apartment, R.drawable.photo_apartment, R.drawable.photo_apartment, R.drawable.photo_apartment};
                                    if (jarr.length() > 0) {
                                        for (int i = 0; i < jarr.length(); i++) {
                                            ...
                                            InformationPermintaanSewa3 current = new InformationPermintaanSewa3();
                                        ...
                                        if (page < 2) {
                                            ...
                                            adapter = new AdapterPermintaanSewa3Paging(ctx, data, recyclerView);
